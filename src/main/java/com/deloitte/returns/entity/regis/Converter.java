...
// Import this package:
//
//     import com.dttillp.ctd.model.regis.Converter;
//
...
public class Converter {
	...
	public static RegistrationNormalTaxPayer fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(RegistrationNormalTaxPayer obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(RegistrationNormalTaxPayer.class);
		writer = mapper.writerFor(RegistrationNormalTaxPayer.class);
	}
