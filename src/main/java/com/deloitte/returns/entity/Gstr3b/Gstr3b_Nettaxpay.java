...
@JsonPropertyOrder({ "trans_typ", "trans_desc", "liab_ldg_id", "sgst", "cgst", "cess", "igst" })

@Entity
@Data
@Table(name = "nettaxpay", schema = "gstr3b")
public class Gstr3b_Nettaxpay implements Serializable {
	...
	private final static long serialVersionUID = 4422853593768187958L;
