...
@Entity
@Data
@Table(name = "osup_nil_exmp", schema = "gstr3b")
public class Gstr3b_OsupNilExmp implements Serializable {
	@Id
	...
	private final static long serialVersionUID = -8937411974255738447L;
