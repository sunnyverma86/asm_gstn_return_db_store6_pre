...
@JsonPropertyOrder({ "iamt", "camt", "csamt", "samt", "ty" })

@Entity
@Data
@Table(name = "itc_rev", schema = "gstr3b")
public class Gstr3b_ItcRev implements Serializable {
	@Id
	...
	private final static long serialVersionUID = 3132395204397004694L;
