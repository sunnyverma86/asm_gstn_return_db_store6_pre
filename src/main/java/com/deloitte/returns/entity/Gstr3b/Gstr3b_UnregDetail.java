...
@Entity
@Data
@Table(name = "unreg_detail", schema = "gstr3b")
public class Gstr3b_UnregDetail implements Serializable {
	...
	private final static long serialVersionUID = 6206374378556522551L;
