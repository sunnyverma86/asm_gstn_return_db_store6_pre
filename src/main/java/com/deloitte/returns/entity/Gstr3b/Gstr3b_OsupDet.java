...
@Entity
@Data
@Table(name = "osup_det", schema = "gstr3b")
public class Gstr3b_OsupDet implements Serializable {
	...
	private double iamt;
	/**
	 * central tax amount available in the current month
	 * 
	 */
	@JsonProperty("camt")
	...
	private double camt;
	/**
	 * State Tax amount available in the current month
	 * 
	 */
	@JsonProperty("samt")
	...
	private final static long serialVersionUID = 8096578919104587984L;
