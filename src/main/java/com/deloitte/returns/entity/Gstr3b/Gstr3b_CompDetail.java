...
@Entity
@Data
@Table(name = "comp_detail", schema = "gstr3b")
public class Gstr3b_CompDetail implements Serializable {
	@Id
	...
	private final static long serialVersionUID = -8247047270436746227L;
