...
@JsonPropertyOrder({ "trans_typ", "trans_desc", "liab_ldg_id", "cgst", "sgst", "cess", "igst" })

@Entity
@Data
@Table(name = "tx_py", schema = "gstr3b")
public class Gstr3b_TxPy implements Serializable {
	...
	@JsonPropertyDescription("Liability ledger Id")
	@Column
	...
	private final static long serialVersionUID = 4365446012114214520L;
