...
public class Converter {
	...
	public static RegistrationTdsTcs fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(RegistrationTdsTcs obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(RegistrationTdsTcs.class);
		writer = mapper.writerFor(RegistrationTdsTcs.class);
	}
