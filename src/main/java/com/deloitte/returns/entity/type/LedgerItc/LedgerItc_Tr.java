...
@NoArgsConstructor
@Entity
@Table(name = "tr", schema = "ledger_itc")
public class LedgerItc_Tr {
	@Id
	...
	@JsonProperty("taxOffDesg")
	private String taxOffDesg;

	@JsonProperty("taxOffNam")
	private String taxOffNam;

	@JsonProperty("taxOffAdmn")
	private String taxOffAdmn;

	@JsonProperty("taxOffJursd")
	private String taxOffJursd;
