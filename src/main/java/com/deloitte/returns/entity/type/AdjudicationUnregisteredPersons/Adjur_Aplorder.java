...
@NoArgsConstructor
@Entity
@Table(name = "aplorder", schema = "adjudication_unregistered_persons")
public class Adjur_Aplorder {
	...
	private Adjur_Dispamt dispamt;

	@JsonProperty("dtramt")
	@OneToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "dtramt_id")
	private Adjur_Dtramt dtramt;
	...
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "aplorder_id")
	private List<Adjur_Igstdtls> igstdtls;
