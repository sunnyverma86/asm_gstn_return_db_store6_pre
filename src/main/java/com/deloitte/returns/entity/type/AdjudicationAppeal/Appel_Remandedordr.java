...
@NoArgsConstructor
@Entity
@Table(name = "remandedordr", schema = "adjudication_appeal")
public class Appel_Remandedordr {
	...
	private Appel_Tpovl tpovl;

	@JsonProperty("gdssvcdtls")
	@OneToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "gdssvcdtls_id")
	private Appel_Gdssvcdtls gdssvcdtls;

	@JsonProperty("suppdocs")
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "remandedordr_id")
	private List<Appel_Suppdocs> suppdocs;

	@JsonProperty("maindocs")
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "remandedordr_id")
	private List<Appel_Maindocs> maindocs;

	@JsonProperty("annxdocs")
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "remandedordr_id")
	private List<Appel_Annxdocs> annxdocs;

	@JsonProperty("dmddtls")
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "remandedordr_id")
	private List<Appel_Dmddtls> dmddtls;
