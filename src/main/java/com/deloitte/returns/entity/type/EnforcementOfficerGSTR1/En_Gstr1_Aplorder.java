...
@NoArgsConstructor
@Entity
@Table(name = "aplorder", schema = "enforcement_officer_gstr1")
public class En_Gstr1_Aplorder {
	...
	private En_Gstr1_Dtramt dtramt;

	@JsonProperty("dispamt")
	@OneToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "dispamt_id")
	private En_Gstr1_Dispamt dispamt;
	...
	@JsonProperty("igstdtls")
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "aplorder_id")
	private List<En_Gstr1_Igstdtls> igstdtls;
