...
@JsonPropertyOrder({ "iamt", "samt", "camt", "liab_id", "debit_id", "trancd", "trandate" })

@Entity
@Table(name = "pd_by_cash", schema = "gstr8")
@Data
public class Gstr8_PdByCash implements Serializable {
	...
	private final static long serialVersionUID = -7010970432267277983L;
