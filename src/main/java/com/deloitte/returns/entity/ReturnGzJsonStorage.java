...
@NoArgsConstructor
@Entity
//@Table(name = "return_gz_json_storage", schema = "asm")
@Table(name = "return_gz_json_storage", schema = "filecounter")
public class ReturnGzJsonStorage implements BaseJsonEntity {
