...
@JsonPropertyOrder({ "cfs", "ctin", "inv" })
@Generated("jsonschema2pojo")
@Entity
@Table(name = "b2ba", schema = "gstr5")
@Data
public class Gstr5_B2ba implements Serializable {
	...
	private final static long serialVersionUID = 5121653099818606345L;
