...
// Import this package:
//
//     import com.dttillp.ctd.model.Refund.Converter;
//
// Then you can deserialize a JSON string with
//
//     Refund data = Converter.fromJsonString(jsonString);
...
public class Converter {
	...
	public static Refund fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(Refund obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(Refund.class);
		writer = mapper.writerFor(Refund.class);
	}
