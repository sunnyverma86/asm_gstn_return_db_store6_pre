...
@Entity
@Table(name = "b2ba", schema = "gstr2a")
@Data
public class Gstr2a_B2ba implements Serializable {
	@Id
	...
	public List<Gstr2a_Inv> gstr2aInv = new ArrayList<Gstr2a_Inv>();

	private final static long serialVersionUID = -6112329543091325913L;
